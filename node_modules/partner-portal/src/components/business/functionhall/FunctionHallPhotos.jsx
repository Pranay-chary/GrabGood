...
const FunctionHallPhotos = ({ photos, onChange }) => {
  const [photoCategory, setPhotoCategory] = useState('hall');
  ...
  const categories = [
    ...
    { id: 'setup', label: 'Seating Arrangements' },
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900">Function Hall Photos</h3>
...
export default FunctionHallPhotos; 